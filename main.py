...
import logging
import os
from PyQt6.QtWidgets import QApplication, QMainWindow, QTabWidget, QPushButton, QWidget, QVBoxLayout, QHBoxLayout, QLabel, QTabBar
...
class DUO_ToolKit(QMainWindow):
    ...
    def open_tool(self, tool_name):
        ...
        try:
            module = importlib.import_module(f"tool{tool_name[2:]}")
